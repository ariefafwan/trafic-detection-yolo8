...
video_path = './Predict/Video/Pasar Banyumanik.mp4'
output_path = 'Pasar BanyumanikOutput.mp4'
...
# Menentukan koordinat untuk garis miring (koordinat titik)
...
destination = 'video_result/Pasar Banyumanik'  # ganti dengan folder tujuan
